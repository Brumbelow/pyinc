...
| `textDocument/semanticTokens/full`, `textDocument/semanticTokens/range` | Namespace, class, function, method, parameter, and variable tokens. | No delta response. Use-site classification covers lexical names, not general attribute chains. |
