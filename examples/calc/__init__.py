...
single shared ``FileResource``, exact raw text with parsed-payload backdating on
comment/whitespace edits, per-name incremental evaluation, and output
reconciliation through the ``@action`` layer.
